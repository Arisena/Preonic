 ...
 */
	[0] = LAYOUT_preonic_1x2uC(
		...
		KC_LCTL, KC_RSFT, KC_LGUI, KC_RALT, MO(1),    KC_SPC   , MO(2), KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT),
 ...
 */
	[1] = LAYOUT_preonic_1x2uC(
			...
			KC_LCTL, KC_RSFT, KC_LGUI, KC_RALT, KC_TRNS,     KC_SPC      , MO(3)  , KC_MUTE, KC_MPRV, KC_MNXT, KC_MPLY),
 ...
 */
	[2] = LAYOUT_preonic_1x2uC(
			...
			KC_LCTL, KC_RSFT, KC_LGUI, KC_RALT, MO(3) ,    KC_SPC     , KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY),

 ...
 * |   `  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | PSCR |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |   _  |   +  |   {  |   }  |  Ins |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |   |  |   |  | Home |  End |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |RShift| Mod  | Alt  |Lower |    Space    |MO(3) | Mute | Prev | Next | Play |
 * `-----------------------------------------------------------------------------------'
 */
	[1] = LAYOUT_preonic_1x2uC(
			KC_ESC , KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
			KC_TILD, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
			KC_PSCR, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_INS,
			KC_LSFT, KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 , KC_PIPE, KC_PIPE, KC_HOME, KC_END , KC_ENT,
			KC_LCTL, KC_RSFT, KC_LGUI, KC_LALT, KC_TRNS,     KC_SPC      , MO(3)  , KC_MUTE, KC_MPRV, KC_MNXT, KC_MPLY),
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | PSCR |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |   -  |   =  |   [  |   ]  | Num/ |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |   \  |   \  | PGUP |PGDOWN|Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |RShift| Mod  | Alt  |MO(3) |    Space    |Raise | Mute | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
	[2] = LAYOUT_preonic_1x2uC(
			...
			KC_LCTL, KC_RSFT, KC_LGUI, KC_LALT, MO(3) ,    KC_SPC     , KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY),
